...
public class DbAccess
{
	...
	public void readConfig()
	{
		...
		try
		{
			String strConfig = myFileOpen.ReadFileContents(strWorkDir + sep + "Config" + sep + "config_mysql.txt");
	...
	public String fireSQL(String mytodo)
	{
		...
		{
        	sout.println(1, "DbAccess.fireSQL(): " + todo + " --> " + e);
        	return("Fehler!");
		}
		return (todo);
	}
	public ResultSet fireSQL_RS(String mytodo)
	{
		...
		{
			sout.println(1, "DbAccess.fireSQL_RS(): " + todo + " --> " + e);
		}
		return r;
	}
						 ...
						 String myLike)
	{
		...
		{
        	sout.println(1, "DbAccess.create(): " + todo + " --> " + e);
        	return("Fehler!");
		}
		return (todo);
	}
			             ...
			             String myValues) 
	{
		...
		{
			sout.println(1, "DbAccess.insert(): " + todo + " --> " + e);
        	return("Fehler!");
		}
        return (todo);
	}
	public String select(String myTable, String myColumns, String myCrit) 
	{
        ...
        {
        	sout.println(1, "DbAccess.select(): " + todo + " --> " + e);
        	return("Fehler!");
        }
        return(todo);
	}
	public String selectCOUNT(String myTable, String myColumns, String myCrit) 
	{
        ...
        {
        	sout.println(1, "DbAccess.selectCOUNT(): " + todo + " --> " + e);
        	return("Fehler!");
        }
        return(todo);
	}
	public ResultSet getSet(String myTable, String myColumns, String myCrit) 
	{
		...
		{
			sout.println(1, "DbAccess.getSet (" + todo + ") " + e);
		}
		return r;
	}
	public String update(String myTable, String myValues, String myCrit) 
	{
		...
		{
			sout.println(1, "DbAccess.update(): " + todo + " --> " + e);
        	return("Fehler!");
		}
        return (todo);
	}
	public String delete(String mySchema, String myTable, String myCrit) 
	{
		...
		{
			sout.println(3, "DbAccess.delete(): " + todo + " --> " + e);
        	return("Fehler!");
		}
        return (todo);
	}
	public String dropTable(String mySchema, String myTable)
	{
		...
		{
			sout.println(1, "DbAccess.dropTable(): " + todo + " --> " + e);
        	return("Fehler!");
		}
        return (todo);
	}
