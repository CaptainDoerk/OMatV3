							 ...
							 implements ActionListener
{
	...
	public CountDownSetter(long lngRestZeit, long lngMaxMilli)
	{
		...
		labMinuten = new JLabel(intToStr(intMinuten), SwingConstants.CENTER);
        ...
        labSekundn = new JLabel(intToStr(intSekundn), SwingConstants.CENTER);
	...
	static String intToStr(int myInt)
	{
		String myStr;
		if(myInt >= 10)
		{
