...
public class HTMLWriter 
{
	...
	public HTMLWriter(int intDebugLvl, DbAccess myAccess, String strTurnierName)
	{
	...
	public void writeSpielPlan(String strUhrZeit)
	{
		...
		try 
		{
			...
			strText		+= "<th width='20%'>Team1Sp1</th>";
			strText		+= "<th width='20%'>Team1Sp2</th>";
			strText		+= "<th width='20%'>Team2Sp1</th>";
			strText		+= "<th width='20%'>Team2Sp2</th>";
			strText		+= "<th width='10%'>Tore</th>";
			strText		+= "</tr>" + ret;
	    	...
	    	try
	    	{
	    		while(myResultSet.next())
	    		{
	    			...
	    			if(Integer.parseInt(strCode) == 0)
	    			{
    					...
    					strText	+= "<td class='gr_" + strGrpp + "'>" + myResultSet.getString("Team1Sp1") + "</td>";
    					strText	+= "<td class='gr_" + strGrpp + "'>" + myResultSet.getString("Team1Sp2") + "</td>";
    					strText	+= "<td class='gr_" + strGrpp + "'>" + myResultSet.getString("Team2Sp1") + "</td>";
    					strText	+= "<td class='gr_" + strGrpp + "'>" + myResultSet.getString("Team2Sp2") + "</td>";
	    			...
	    			if(Integer.parseInt(strCode) == 1)
	    			{
	    				...
	    				strText	+= "<td class='active'>" + myResultSet.getString("Team1Sp1") + "</td>";
	    				strText	+= "<td class='active'>" + myResultSet.getString("Team1Sp2") + "</td>";
	    				strText	+= "<td class='active'>" + myResultSet.getString("Team2Sp1") + "</td>";
	    				strText	+= "<td class='active'>" + myResultSet.getString("Team2Sp2") + "</td>";
	    			...
	    			if(Integer.parseInt(strCode) == 8)
	    			{
	    				...
	    				strText	+= "<td class='played'>" + myResultSet.getString("Team1Sp1") + "</td>";
	    				strText	+= "<td class='played'>" + myResultSet.getString("Team1Sp2") + "</td>";
	    				strText	+= "<td class='played'>" + myResultSet.getString("Team2Sp1") + "</td>";
	    				strText	+= "<td class='played'>" + myResultSet.getString("Team2Sp2") + "</td>";
	...
	public void writeGruppe(String strGruppe, String strUhrZeit)
	{
		...
		try 
		{
			...
			strText		+= "</tr>" + ret;
			myResultSet = myAccess.getSet(strTurnierName + "_tbl", "*", "Gruppe = '" + strGruppe + "'");
	    	try
	    	{
	    		while(myResultSet.next())
	    		{
    				strText += "<tr>";
    				strText	+= "<td class='gr_" + strGruppe + "'>" + myResultSet.getString("SpielerID") + "</td>";
    				...
    				strText	+= "<td class='gr_" + strGruppe + "'>" + myResultSet.getString("Siege") + "</td>";
    				strText	+= "<td class='gr_" + strGruppe + "'>" + myResultSet.getString("Unentschieden") + "</td>";
    				strText	+= "<td class='gr_" + strGruppe + "'>" + myResultSet.getString("Niederlagen") + "</td>";
...
/*			strText		+= "</body><tr></table></html>";
			...
			strText		+= "<th width='10%'>Tore</th>";
			strText		+= "</tr>" + ret;
			myResultSet = myAccess.getSet(strTurnierName + "_spl", "*", "Gruppe = '" + strGruppe + "'");
	    	try
	    	{
	    		while(myResultSet.next())
	    		{
	    			...
	    			if(Integer.parseInt(strCode) == 0)
	    			{
	    				...
	    				strText	+= "<td class='gr_" + strGruppe + "'>" + myResultSet.getString("Team1Sp1") + "</td>";
	    				strText	+= "<td class='gr_" + strGruppe + "'>" + myResultSet.getString("Team1Sp2") + "</td>";
	    				strText	+= "<td class='gr_" + strGruppe + "'>" + myResultSet.getString("Team2Sp1") + "</td>";
	    				strText	+= "<td class='gr_" + strGruppe + "'>" + myResultSet.getString("Team2Sp2") + "</td>";
