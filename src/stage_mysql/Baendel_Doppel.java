...
public class Baendel_Doppel 
{
	...
	public void setActives()
	{
		...
		strActives.add("Buzz-T");
		strActives.add("Ivan");
		strActives.add("Luca Toni");
		strActives.add("Mad Maz");
		strActives.add("Schnelle");
		strActives.add("Raphi");
		strActives.add("Tha Man");
		strActives.add("Dirk L.");
		strActives.add("Inge");
		strActives.add("Timskinho");
		strActives.add("Jean");
		strActives.add("Gerrit");
		strActives.add("Jupp");
...
//		strActives.add("");
		...
		intBlock = 6;					//Anzahl Spiel-Blöcke (Spiele je Spieler)
		/**
		 * Bei Modulo-Rest 1 und 3 entweder 4 oder 8 Spiele pro Spieler
		 */
...
//				System.out.println("....");
    ...
    {
		System.out.println("Insert.. Anzahl Partien: " + (intSize*intBlock)/4);
    	DbAccess myAccess = new DbAccess(8);
    	for(int i=0; i<partien.size(); i+=4)
    	{
    		myAccess.insert("kcxx_spl", "Team1Sp1, Team1Sp2, Team2Sp1, Team2Sp2", "'" +
    			partien.get(i)   + "', '" +
    			partien.get(i+1) + "', '" +
    			partien.get(i+2) + "', '" + 
    			partien.get(i+3) + "'" 
    	...
    	{
			myAccess.insert("kcxx_tbl", "ID, SpielerID, Elo", String.valueOf(i+1)   + ", '" + strActives.get(i)  + "', 500");
    	}    
    }
}
