...
//				panPenalty.stop();				//TODO Ärger mit Sirenen
		...
		/***************************************************
		 * Spiel laden / Übernehmen / Hole Spiele gedrückt *
		 ***************************************************/
...
//				panPenalty.reset();					//TODO Ärger mit Sirenen
				...
				try
				{
					sout.println(5, "TestOMat.actionPerformed('Übernehmen'): refreshSet()");
	...
	public void setSpiel()
	{
		...
		strSpBerName 	= strTurnierName 
						...
						+ strTNamG.replace(" ", "_");
		myAccess.create("kc", strSpBerName, "_tpl_spielbericht");		//legt eine Tabelle für Spielbericht an
...
//			myMP3Thread.interrupt();
	...
	public void showSpiel()
	{
        ...
        try
        {
        	...
        	strTeam1	= myResultSet.getString("Team1");		//Für DB-Update und Toranzeige die TeamID
        	...
        	strTeam2	= myResultSet.getString("Team2");		//Für DB-Update und Toranzeige die TeamID
